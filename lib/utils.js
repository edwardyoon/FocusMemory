...
dotenv.config({ override: true, quiet: true }); // .env 우선(override). quiet:true 필수 — ESM import 호이스팅으로 이 호출이 index.js보다 먼저 실행돼 stdout 배너가 MCP stdio JSON-RPC 프레임을 깨뜨린다
