...
# Bonsai lightweight LLM for prune & summarize (optional, graceful fallback if unavailable)
BONSAI_URL=http://127.0.0.1:8081/v1/chat/completions
BONSAI_MODEL=bonsai-27b
